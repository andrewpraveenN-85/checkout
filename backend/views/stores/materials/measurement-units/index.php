        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?= $model->isNewRecord ? 'Create Measurement Units' : 'Update Measurement Units - ' . Html::encode($model->name) ?></h5>
                    <button type="reset" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        <?= $form->field($model, 'name')->textInput(['maxlength' => 200, 'placeholder'=>'Measurement Units name']) ?>
                    </div>
                    <div class="mb-3">
...
$this->registerJs("
    $(document).ready(function() {
        ...
        myModalEl.addEventListener('hidden.bs.modal', function (event) {
            window.location.href = '/stores/materials/measurement-units'; // Replace '/index' with the actual route to your index page.
        });
    });

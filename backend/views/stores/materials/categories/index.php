        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?= $model->isNewRecord ? 'Create Categories' : 'Update Categories - ' . Html::encode($model->name) ?></h5>
...
$this->registerJs("
    $(document).ready(function() {
        ...
        myModalEl.addEventListener('hidden.bs.modal', function (event) {
            window.location.href = '/stores/materials/categories'; // Replace '/index' with the actual route to your index page.
        });
    });
